...
Co-authored 12 sources in this wiki — the **CMOP-evolutionary UAV-MEC** lineage, the Geng Sun group's collaborative-beamforming work, generative-AI/diffusion methods, a human-digital-twin edge-deployment paper, and a UAV-swarm collaborative-inference article:
...
- Recurring co-author in the [[constrained-multi-objective-evolutionary-algorithm|CMOP-evolutionary]] lineage. Broader research on blockchain, federated learning, and edge incentives overlaps with the wiki's [[zero-trust-architecture|zero-trust]] and [[blockchain-for-fl-aggregation|blockchain]] threads, though those threads are anchored by different sources ([[mao-2025-bcsa-frl]], [[qin-2025-bcuav-masac]]).
