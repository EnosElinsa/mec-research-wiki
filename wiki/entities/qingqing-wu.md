...
Co-authored 11 sources in this wiki, spanning UAV ISAC, aerial MEC, collaborative beamforming, URLLC-based UAV-MEC, two-timescale UAV-MEC, UAV-mounted-RIS communications, and UAV-swarm virtual antenna arrays:
...
- [[li-2024-emssa-uav-swarm-vaa]] — multi-objective UAV-swarm + IoT collaborative beamforming with virtual antenna arrays (EMSSA).
...
- A UAV-communications/ISAC specialist who recurs across the Jilin-University aerial-MEC cluster (with [[geng-sun]]) and the ISAC overview thread.
