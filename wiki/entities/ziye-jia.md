...
- [[jia-2026-dro-lawn-trajectory]] — distributionally robust computation offloading and trajectory optimization in low-altitude wireless networks (lead author).
- [[jia-2026-hierarchical-uav-swarms]] - hierarchical head/tail UAV-swarm deployment, collection trajectories, and multi-objective power control (lead author).

## Contributions to this wiki

- A lead author of the NUAA aerial-computing cluster, working with [[chao-dong]], [[qihui-wu]], and [[zhu-han]] on HAP-UAV MEC, maritime AAV cooperation, and hierarchical UAV-swarm collection/control.
