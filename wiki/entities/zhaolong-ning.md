...
- [[ning-2023-uav-mec-offloading-deployment]] - dynamic computation offloading and UAV-server deployment.
- [[chen-2024-thoas-traffic-aware-sagin]] - traffic-aware hierarchical offloading and network slicing in SAGIN.
- [[ning-2025-channel-aware-irs-uav]] - channel-aware IRS-user association, UAV trajectories, and NOMA power control.
- [[hu-2026-segmented-irs-cpn]] - dynamically segmented IRS allocation in UAV computing-power networks.
...
- Connects a recurring CQUPT research line from competitive UAV service markets and trajectory control to IRS-assisted multi-UAV communications, computing-power networks, freshness control, and secure low-altitude edge systems.
