...
Co-authored 6 sources in this wiki across wireless-powered MEC, UAV resource optimization, embodied tracking, secure vehicular communication, freshness-aware collection, and anti-jamming spectrum sharing:
...
- [[li-2026-la4h-uav-active-tracking]] - expert-assisted anomaly-aware UAV active tracking with teacher-student distillation.
- [[li-2026-secrecy-ee-uav-ris-iov]] - untrusted-relay vehicular security with UAV-RIS assistance and secrecy-energy-efficiency optimization.
- [[ding-2026-optimization-driven-spectrum-sharing]] - robust optimization-guided DRL for licensed/unlicensed UAV spectrum sharing.

## Contributions to this wiki

Connects the corpus's classical UAV-MEC energy-optimization line to later learning-based UAV perception and [[physical-layer-security]]. The six sources span RF-powered computation, MISO resource/trajectory design, freshness-aware collection, expert-assisted tracking, secure mobile IoV, and robust anti-jamming spectrum sharing.
