...
A recurring co-author in the aerial-MEC / low-altitude-economy cluster centered on [[geng-sun]], and lead author of the UAV collaborative-beamforming energy-MOP work. The shared `nenu.edu.cn` email and identical Northeast Normal University affiliation across all sources confirm a single identity (not a namesake).
