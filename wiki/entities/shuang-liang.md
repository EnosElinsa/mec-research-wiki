...
type: entity
title: Shuang Liang
tags: [author, researcher, aerial-mec, low-altitude-economy]
related:
...
A recurring co-author in the aerial-MEC / low-altitude-economy cluster centered on [[geng-sun]]. The shared `nenu.edu.cn` email and identical Northeast Normal University affiliation across all three sources confirm a single identity (not a namesake), so the entity is created here rather than deferred.
