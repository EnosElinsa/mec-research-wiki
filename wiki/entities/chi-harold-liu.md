...
tags: [author, mobile-crowdsensing, deep-reinforcement-learning, multi-uav]
related:
...
- Connects the corpus's early distributed multi-UAV coverage-control work to energy-aware mobile crowdsensing and later heterogeneous air-ground crowdsensing.
- Recurring themes include partially observed multi-agent control, geographic sensing fairness, energy-aware mobility, and reinforcement learning for mobile crowdsensing.
