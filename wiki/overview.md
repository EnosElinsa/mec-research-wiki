...
- **Curated sources:** 96 (12 initial + 14 from the first 2026-05-29 batch + 13 from the second 2026-05-29 batch + 43 from the third 2026-05-29 batch + 7 from batch 1/8 + 7 from batch 2/8 of the 2026-05-31 multi-batch run) — see `wiki/index.md` for the type-grouped directory.
- **Concepts:** 182 across MEC fundamentals, aerial architectures, DRL backbones, game theory, optimization techniques (classical + evolutionary + DRO), channel modeling, sensing + security, distributed inference, federation, generative-AI, and fairness/freshness metrics — including a [[fairness-metrics-in-mec]] synthesis hub. Batch 1/8 added [[collaborative-beamforming]], [[coalition-formation-game]], [[cellular-connected-uav]], and [[uav-data-collection]]. Batch 2/8 added [[soft-actor-critic]] (base single-agent SAC) and [[prospect-theory]] (risk-aware offloading).
- **Entities:** 48 author pages + [[pytorch]] (49 entity pages total). Batch 2/8 created **no** new entity pages — it bumped existing rosters ([[dusit-niyato]] 11→12, [[jiawen-kang]] 6→7, [[zhu-han]] 4→5) and **deferred** one author (Hongyang Du, lead of [[du-2024-d2sac-aigc-asp-selection]]) for human confirmation: his bio lists the University of Hong Kong while his other corpus paper [[ye-2025-aigc-diffusion-contract]] lists him at NTU, so no entity was minted. Batch 1/8 added [[boxiong-wang]] and [[hui-kang]] (both Jilin University, [[geng-sun]] aerial-MEC cluster, 2 sources each, email-confirmed). The 2026-05-31 pass added 8 affiliation-verified authors ([[shuang-liang]]; [[weifeng-zhong]], [[shengli-xie]]; [[qiqi-xie]]; [[nei-kato]], [[jiadai-wang]], [[yijie-xun]], [[yangbo-liu]]). The 2026-05-30 pass added 5 confirmed authors ([[ying-chen]], [[jie-xu]], [[fuhong-song]], [[yong-wang]], [[wei-zhang]]); one recurring "Nan Zhao" name remains deferred as a genuine namesake (two different institutions). A second deferral was logged in batch 1/8: a "Qingqing Wu" in the 2019 UAV tutorial is listed at NUS, not SJTU, so it was not merged into [[qingqing-wu]]. Earlier passes confirmed the 21 batch-4 authors (NUAA, Jilin/NTU, Dalian-Maritime, NWPU, NCEPU, SCAU clusters + cross-cutting seniors).
...
| Classical/convex optimization UAV-MEC | [[zhang-2019-uav-iot-comp-comm]], [[yu-2020-uav-ec-collaborative-offloading]], [[liu-2022-miso-uav-mec-trajectory]], [[yang-2022-stochastic-uav-mec-lyapunov]], [[wang-2022-cat-rat-fmec-trajectory]], [[bai-2024-delay-aware-cooperative-edge-cloud]], [[apostolopoulos-2021-prospect-theory-uav-offloading]] | Large SCA/AO/Lyapunov sub-corpus + convex-vs-DRL + edge-cloud + prospect-theory game |
...
8. **Most papers are still simulation-only.** Only 2 of 96 curated sources are hardware-validated ([[sun-2024-asap-uav-swarm]], [[shao-2024-drl-antijamming-mec]]); [[bai-2024-delay-aware-cooperative-edge-cloud]] adds a real UAV-edge platform used to *verify its model* (not a full algorithm deployment). Worth keeping in mind for any thesis claim.
