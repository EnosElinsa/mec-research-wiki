...
In the wiki, [[song-2024-mol-aoi-energy]] formalizes this tradeoff and solves it with [[multi-objective-reinforcement-learning]] (MOL-AET) to produce nondominated policies spanning energy-focused (short, cautious paths) to AoI-focused (long, sweeping paths) preferences. [[liao-2026-aoi-ris-uav-usv-mec]] gives the maritime/RIS version by minimizing a weighted sum of USV average AoI and RUAV flight energy, while [[cai-2026-llm-drl-secure-lae-data]] folds AoI and energy into secure LAE data collection. It is the freshness-flavored sibling of the energy-vs-delay and [[energy-balancing-uav]] tradeoffs elsewhere in the corpus.
