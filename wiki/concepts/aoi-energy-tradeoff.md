...
In the wiki, [[song-2024-mol-aoi-energy]] formalizes this tradeoff and solves it with [[multi-objective-reinforcement-learning]] (MOL-AET) to produce nondominated policies spanning energy-focused (short, cautious paths) to AoI-focused (long, sweeping paths) preferences. It is the freshness-flavored sibling of the energy-vs-delay and [[energy-balancing-uav]] tradeoffs elsewhere in the corpus.
