...
Used in [[jia-2025-dro-uav-hap-mec]] for the binary task-offloading subproblem (which task goes to which UAV vs the HAP) after primal decomposition reduces the original MISOCP. Justified empirically against exhaustive-search, greedy, and simulated-annealing baselines.
