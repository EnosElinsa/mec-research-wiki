...
[[attentive-memory-integrated-information-exchange]] specializes hidden-state sharing by attending over link-qualified messages and already selected actions while retaining persistent per-agent memory across unequal-duration decisions.
