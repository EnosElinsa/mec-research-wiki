...
In the wiki, [[hsu-2025-drl-hues-hap-noma]] uses the SAGIN frame explicitly to model HAP-as-relay between ground stations and a satellite. [[mao-2025-bcsa-frl]] sits at the LEO-tier of a SAGIN. [[he-2026-dt-sagimec-lae]] makes the SAGIN stack a low-altitude-economy MEC substrate: ISDs offload through a UAV and selected LEO satellite paths while a cloud-side digital twin mirrors the physical layers. [[zhao-2025-probabilistic-semantic-sagin]] uses a satellite-UAV-ground relay chain to study the communication-versus-computation energy tradeoff of [[probabilistic-semantic-communication]]. [[zhao-2026-hcdrl-ga-sagin-sar]] uses the SAGIN tiers as offloading targets in a multi-UAV search-and-rescue setting, adding wind-aware deployment and online trajectory/offloading control. [[chen-2026-pddqn-sagin-mec]] uses a LEO-UAV-ground MEC stack for remote IoT, with satellite coverage time constraining a hybrid-action offloading/resource-allocation policy. [[diallo-2026-system-cost-uav-leo-offloading]] uses UAVs as the aerial access/compute tier and LEO satellites as the wide-area compute tier while optimizing task dropping, power, trajectory, and scheduling cost. The narrower **air-ground integrated network (IAGN)** in [[jiang-2025-isac-lae-overview]] and [[wang-2025-lae-network-survey]] is a SAGIN minus the satellite layer.

[[tan-2025-sagin-outage-altitude]] adds the physical-reliability view: a solar-powered UAV relay must satisfy both energy- and SNR-outage conditions while balancing the ground-air and air-satellite hops through altitude and position angle.

[[kim-2026-qmarl-sagin-access]] coordinates CubeSats and HALE-UAVs through [[quantum-marl-sagin-access]], combining differentiated ground-station access requirements with sun-side charging and aerial residual energy.
