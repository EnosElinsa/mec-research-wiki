...
[[meng-2026-fullspace-star-ris-secure]] maximizes worst-case average secrecy rate when colluding eavesdropper CSI lies in a norm-bounded uncertainty set. Its additional difficulty is geometric: the UAV crosses a STAR-RIS plane, coupling robust surface control and secrecy with reflection/transmission role switching along a [[full-space-star-ris-uav-trajectory]].
