...
In the wiki, [[hao-2024-clp-multiuav-priority-offloading]]'s CLP algorithm builds on TD3, learning over a [[hybrid-action-representation]] latent space. The multi-agent extension [[multi-agent-td3]] (MATD3) is used in [[shao-2024-drl-antijamming-mec]]. TD3 is the deterministic counterpart to the stochastic, entropy-regularized [[masac|SAC]] family.
