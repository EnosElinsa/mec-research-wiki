...
In the wiki, [[ye-2025-aigc-diffusion-contract]] casts the ASP as the **principal** in a [[contract-theory]] mechanism: it designs a menu of contract items so users self-select truthfully under information asymmetry. The ASP role situates generative AI within the corpus's [[generative-ai-for-mec]] and [[qoe-modeling-mec]] threads, with [[prompt-engineering]] as a distinctive new resource lever.
