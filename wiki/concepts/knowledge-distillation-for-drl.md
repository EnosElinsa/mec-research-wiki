...
In the wiki, [[chen-2024-thoas-traffic-aware-sagin]] distills its converged [[ppo]] offloading policy into a lightweight student: at ~6% of teacher size it retains ~73% performance, ~90% at 12%, ~97% at 50%. This is the corpus's first explicit treatment of on-platform model-size constraints as a first-class design concern for SAGIN edge inference.
