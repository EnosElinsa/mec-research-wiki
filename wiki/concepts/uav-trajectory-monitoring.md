...
This measured tracking output differs from camera-service control in [[zhan-2026-star-ris-aerial-monitoring]] and authorized payload decoding in [[wireless-information-surveillance]]. [[lstm-eavesdropper-trajectory-prediction]] supplies an imputed controller input when Eve is unobserved, rather than a complete sensing/association pipeline. See [[aerial-observation-control-covertness-surveillance-and-monitoring]].
