...
[[zhao-2026-heuristic-supervised-drl]] uses PSO as the upper-tier trajectory planner in a [[heuristic-supervised-drl]] loop, with a supervised bridge predicting candidate plan quality before MARL execution.
