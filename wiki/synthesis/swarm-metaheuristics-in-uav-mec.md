...
| Sparrow search | [[sparrow-search-algorithm]] | [[li-2026-isac-vec-beamforming-deployment]] | Refraction-based-learning SSA | Embedded sub-solver for UAV deployment in ISAC-enhanced VEC |
...
- **Lens/refraction search around promising positions**: [[li-2026-isac-vec-beamforming-deployment]] uses refraction-based learning to improve sparrow-search exploration for UAV deployment before the beamforming block is solved by SCA.
...
- **vs DRL** ([[drl-backbones-across-uav-mec-sources]]): swarm methods run offline per mission plan with no training phase, but cannot do per-slot inference; the embedded cases ([[gao-2024-sagin-perception-offloading]], [[wu-2025-iopo-irs-uav-thz-mec]], [[li-2026-isac-vec-beamforming-deployment]]) pair a swarm sub-solver with another optimizer or learner to combine search flexibility with problem structure.
...
- **Metaphor proliferation, shared substance.** Ten-plus distinct nature metaphors deliver similar mixed-variable search machinery, often with the same chaos-init, discrete-update, archive, or refraction-style improvement operators. Whether the choice of metaphor matters beyond the improvement operators is untested in the corpus.
