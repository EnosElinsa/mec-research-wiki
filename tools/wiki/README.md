...
| `process_refs.py` | Find curation process-narration (batch/pass labels, "this/same batch", dated-run references) leaked into any page except `log.md`. Exit 1 if any found. | `--json` |
