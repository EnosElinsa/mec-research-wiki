...
class FakePage {
  constructor({ redirectHost = "idp.gxu.edu.cn", denyFirstStamp = false, institutionInitiallyReady = true, evaluateFailures = 0, deferCarsiRedirect = false, stayOnCarsi = false } = {}) {
